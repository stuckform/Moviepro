...
namespace Moviepro.Controllers
{
    public class StudiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,FoundedDate,Revenue")] Studio studio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location,FoundedDate,Revenue")] Studio studio)
        {
            if (id != studio.Id)
            {
                return NotFound();
